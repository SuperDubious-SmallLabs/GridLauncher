    ...
    if (success) {
        ...
        if (out) {
            if (alphaMask) {
                ...
                bool isFullScreenBg = (expectedWidth >= 320 && expectedHeight == 240);

                if (bytesPerPixel == 4) {
                    size_t p, total = (size_t)expectedWidth * (size_t)expectedHeight;
                    ...
                    if (!hasRealAlpha) {
                        ...
                        if (rgb) {
                            ...
                            free(out);
                            aThemeImage->spriteData = rgb;
                            aThemeImage->hasAlpha = false;
                        }
                        else {
