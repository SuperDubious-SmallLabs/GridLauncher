...
void showHelpDetails(void* obj1, void* obj2) {
    char* title = (char*)obj1;
    char* body = (char*)obj2;
...
void initHelpMenu() {
    ...
    static char titleTextFull[64];
    snprintf(titleTextFull, sizeof(titleTextFull), "Homebrew Grid Launcher %s", currentversion);
